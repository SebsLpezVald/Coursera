...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        # We group by Launch Site and sum the success (class=1) counts
...
def update_scatter_chart(selected_site, payload_range):
    ...
    if selected_site == 'ALL':
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',
                         ...
                         labels={'class': 'Launch Outcome', 'Payload Mass (kg)': 'Payload Mass (kg) (kg)'},
                         hover_data=['Launch Site'])
    else:
        # Filter further for the selected launch site
